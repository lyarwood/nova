...
class ComputeManager(manager.Manager):
    ...
    def _notify_volume_usage_detach(self, context, instance, bdm, volume_id):
    ...
    def _detach_volume(self, context, volume_id, instance, destroy_bdm=True,
        ...
        self._notify_volume_usage_detach(context, instance, bdm, volume_id)
    ...
    def detach_volume(self, context, volume_id, instance, attachment_id=None):
        ...
        def do_detach_volume(context, volume_id, instance, attachment_id):
            try:
                ...
                with excutils.save_and_reraise_exception():
                    LOG.exception(_LE("Failed to detach %(volume_id)s"),
                        {'volume_id': volume_id}, instance=instance)
